...
var file_order_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x32, 0x9c, 0x04, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x41, 0x0a,
	...
	0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x74, 0x6d,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x47, 0x0a, 0x0c, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x52, 0x65, 0x76, 0x65, 0x72, 0x74, 0x12, 0x1a, 0x2e, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65,
	...
	0x73, 0x65, 0x42, 0x07, 0x5a, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_order_proto_depIdxs = []int32{
	...
	0,  // 7: orderclient.Order.CreateDtm:input_type -> orderclient.CreateRequest
	0,  // 8: orderclient.Order.CreateRevert:input_type -> orderclient.CreateRequest
	1,  // 9: orderclient.Order.Create:output_type -> orderclient.CreateResponse
	...
	1,  // 15: orderclient.Order.CreateDtm:output_type -> orderclient.CreateResponse
	1,  // 16: orderclient.Order.CreateRevert:output_type -> orderclient.CreateResponse
...
func (c *orderClient) CreateDtm(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	out := new(CreateResponse)
	err := c.cc.Invoke(ctx, "/orderclient.Order/CreateDtm", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	CreateDtm(context.Context, *CreateRequest) (*CreateResponse, error)
...
func (*UnimplementedOrderServer) CreateDtm(context.Context, *CreateRequest) (*CreateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateDtm not implemented")
}
...
func _Order_CreateDtm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).CreateDtm(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orderclient.Order/CreateDtm",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).CreateDtm(ctx, req.(*CreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Order_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateDtm",
			Handler:    _Order_CreateDtm_Handler,
		},
		{
